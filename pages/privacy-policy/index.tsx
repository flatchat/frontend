...
const PrivacyPolicy: NextPage = () => {
    return (
        <>
            <Head>
                <title>Privacy Policy - FlatChat</title>
            ...
            <div className='min-h-screen flex flex-col bg-[#2029BA] p-10'>
                ...
                <p>
                    ...
                    In the course of providing the Services, Users may invite other existing Users or other users ("Invited Users") to participate in any of the Services by providing the email address or Mobile Number of such users. FlatChat may thereafter use this information to contact the Invited User and invite such users to register with FlatChat (if such Invited User is not an existing User). The User hereby represents that the Invited Users have consented and agreed to such disclosure to and use of their email address and Mobile Number by FlatChat.
                    ...
                    FlatChat may also share such information with affiliates and third parties in limited circumstances, including for the purpose of providing services requested by the User, complying with legal processes, preventing fraud or imminent harm, and ensuring the security of our network and services.
                ...
                <p>
                    ...
                    By using the Portal, you hereby expressly agree and grant consent to the collection, use, and storage of this information by FlatChat. FlatChat reserves the right to share, disclose and transfer information collected hereunder with its own affiliates. In the event FlatChat sells or transfers all or a portion of its business assets, consumer information may be one of the business assets that are shared, disclosed, or transferred as part of the transaction. You hereby expressly grant consent and permission to FlatChat for the disclosure and transfer of information to such third parties. FlatChat may share information as provided by you and data concerning usage of the Services with its commercial partners for the purpose of facilitating user engagement, marketing, promotional purposes, and other related purposes. Further, FlatChat reserves the right to disclose personal information as obligated by law in response to duly authorised legal processes and governmental requests and as necessary to protect the rights and interests of FlatChat.
                ...
                <p>
                    ...
                    As an alternative to account deletion, by writing to contact@FlatChat.app, you also have the option to request either:
                    ...
                    If you proceed with permanently deactivating your account, you will lose access to the Portal and the Services, including any User data and the personal information associated with your account. Users may request account restoration within three (3) months from the date of notification of account deletion by FlatChat by writing to contact@flatchat.app.
